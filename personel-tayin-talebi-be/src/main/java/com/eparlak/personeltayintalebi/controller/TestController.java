...
@RestController
@RequestMapping("/test-verilerini-yukle")
public class TestController {
    ...
    public String calistir() {
     try{
        System.out.println("test çalıştırılıyor...");
        System.out.println("tumAdliyeleriKaydet çalıştırılıyor...");
        tumAdliyeleriKaydet();
        System.out.println("besTaneAdminYetkiliBirTaneUserPersonelOlustur çalıştırılıyor...");
        besTaneAdminYetkiliBirTaneUserPersonelOlustur();
        System.out.println("elliTaneSahtepersonelOlustur çalıştırılıyor...");
        elliTaneSahtepersonelOlustur();
        System.out.println("talepTurleriOlustur çalıştırılıyor...");
        talepTurleriOlustur();
        System.out.println("tayinCalismalariOlustur çalıştırılıyor...");
        tayinCalismalariOlustur();
        System.out.println("tumPersonelTayinTalebiOlustur çalıştırılıyor...");
        tumPersonelTayinTalebiOlustur();
        System.out.println("test bitti");
    }catch(Exception e){
        return "test çalıştırılırken hata oluştu: " + e.getMessage();
    }

     
        return "test başarılı çalıştı";
    }
